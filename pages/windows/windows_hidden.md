...
{% include info.html content="물론 백신과 같은 동작들은 쉽게 파악할 수 있습니다. 다만 안티-치트와 같이 게임이라는 한정적인 동작에서도 쉽게 찾을 것이라 보장할 수 없습니다."%}
...
{% include info.html content="HideToolz 의 프로세스 은닉 기법을 탐지하기 위한 커널 드라이버 입니다. 알고리즘은 마지막에 다루겠습니다."%}
