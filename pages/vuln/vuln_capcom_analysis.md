...
{% include warning.html content="I/O Control Code를 정의할 때 Microsoft에서 정한 룰이 존재합니다. <a href="https://docs.microsoft.com/en-us/windows-hardware/drivers/kernel/defining-i-o-control-codes">제어 코드 정의</a> 에서 확인할 수 있습니다." %}
